...
class MyLocation {
    ...
    fun getLocation(context: Context, result: LocationResult?): Boolean {
        ...
        timer1 = Timer()
        timer1!!.schedule(GetLastLocation(context, locationListenerGps, locationListenerNetwork), 20000)
        return true
    }
    ...
    var locationListenerNetwork: LocationListener = object : LocationListener {
     ...
     class GetLastLocation(var context: Context,var locationListenerGps1: LocationListener,var locationListenerNetwork1: LocationListener) : TimerTask() {

        override fun run() {
            lm?.removeUpdates(locationListenerGps1)
            lm?.removeUpdates(locationListenerNetwork1)
